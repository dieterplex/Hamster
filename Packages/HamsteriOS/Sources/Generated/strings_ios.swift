...
public enum L10n {
  ...
  public enum KB {
    ...
    public enum SpaceSettings {
      ...
      /// 1. 仅对内置键盘有效。
      /// 2.自定义键盘在配置文件中设置。
      public static let enableLoadingTextRemark = L10n.tr("Localizable", "k_b.space_settings.enable_loadingText_remark", fallback: "1. 仅对内置键盘有效。\n2.自定义键盘在配置文件中设置。")
      /// 空格长显文字
    ...
    public enum SwipeSetting {
      ...
      /// 删除
      public static let delete = L10n.tr("Localizable", "k_b.swipe_setting.delete", fallback: "删除")
      /// 确认删除
      ...
      /// 保存
      public static let save = L10n.tr("Localizable", "k_b.swipe_setting.save", fallback: "保存")
      /// 划动操作
