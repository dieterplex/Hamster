...
class BackupViewController: NibLessViewController {
  ...
  func deleteBackupAction() {
    ...
    alertController.addAction(UIAlertAction(title: L10n.Common.confirm, style: .destructive, handler: { [unowned self] _ in
      Task {
  ...
  func renameAction() {
    ...
    alertController.addAction(UIAlertAction(title: L10n.Common.confirm, style: .destructive, handler: { [unowned self, alertController] _ in
      Task {
